...
\include{chapters/ch01-segnali_principali.tex}
\include{chapters/ch02-vfc.tex}
\include{chapters/ch03-interfaccia_ingresso.tex}
\include{chapters/ch04-selezione_modalità.tex}
\include{chapters/ch05-segnali_secondari.tex}
\include{chapters/ch06-interfaccia_uscita.tex}
%\include{chapters/ch07-protezione_circuito.tex}
%\include{chapters/ch08-suddivisione_schede.tex}
\include{chapters/ch09-conclusioni.tex}

% appendice schemi elettrici
\appendix
\chapter{Schemi Elettrici delle Schede}
\includepdf[pages=-]{pdfs/schematics/FG-VCO-(complete).pdf}
