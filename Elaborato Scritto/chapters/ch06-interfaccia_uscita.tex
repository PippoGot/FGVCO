...
Misurando il valore del guadagno con il setup di misura riportato in figura \ref{mis_filter},
vediamo che il comportamento del circuito teorico viene rispettato.
